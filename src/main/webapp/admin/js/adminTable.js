...
$(function () {
    ...
    $(".panel-default").on("click",".addItem.order",function () {
        ...
        showForm(id,"添加问题",formList,"确认添加","取消添加","editAction addOrderAction");
        setAddFormInfo();
    });
    //确认添加运维人员
    $(".panel-default").on("click",".addItem.operator",function () {
        var id = $(this).parents("tr").attr("item-id");
        showForm(id,"添加运维人员",formList,"确认添加","取消添加","editAction addOperatorAction");
        setAddFormInfo();
    });
    //确认添加用户
    $(".panel-default").on("click",".addItem.user",function () {
        var id = $(this).parents("tr").attr("item-id");
        showForm(id,"添加用户",formList,"确认添加","取消添加","editAction addUserAction");
        setAddFormInfo();
    });
    //确认修改订单
    ...
    //修改用户
    $(".form").on("click",".updateUserAction",function () {
        updateUser();
    });
    //添加订单
...
function getEditUserFormBodyHTML(user) {
    var userFormBodyHTML =  '<div class="info"><span class="name">工号</span><input type="text" class="content id" value="'+dataLoad(user.id)+'" disabled></div>\n' +
        '<div class="info"><span class="name">姓名</span><input type="text" class="content name" value="'+dataLoad(user.name)+'"></div>\n'+
        '<div class="info"><span class="name">联系方式</span><input type="text" class="content phone" value="'+dataLoad(user.phone)+'"></div>\n';
    return userFormBodyHTML;
}
//运维数据面板
function getEditOperatorFormBodyHTML(operator) {
    var operatorFormBodyHTML =  '<div class="info"><span class="name">工号</span><input type="text" class="content id" value="'+dataLoad(operator.id)+'" disabled></div>\n' +
    '<div class="info"><span class="name">姓名</span><input type="text" class="content name" value="'+dataLoad(operator.name)+'"></div>\n'+
    '<div class="info"><span class="name">联系方式</span><input type="text" class="content phone" value="'+dataLoad(operator.phone)+'"></div>\n';
    return operatorFormBodyHTML;
}
//订单数据面板
function getEditOrderFormBodyHTML(order) {
    var order_user = order.user == null? "":order.user.name;
    var orderFormBodyHTML = '<div class="info"><span class="name">报修人</span><input type="text" class="content user" value="'+dataLoad(order_user)+'" disabled></div>\n' +
    '<div class="info"><span class="name">地点</span><input type="text" class="content location" value="'+dataLoad(order.location)+'" disabled></div>\n'+
    '<div class="info"><span class="name">预约时间</span><input type="text" class="content beginTime" value="'+dateLoad(dataLoad(order.beginTime))+'" disabled></div>\n'+
    '<div class="info"><span class="name">用户备注</span><textarea rows="5" class="content userDescription">'+dataLoad(order.userDescription)+'</textarea rows="5"></div>\n'+
    '<div class="info"><span class="name">备注</span><textarea rows="5" class="content description">'+dataLoad(order.description)+'</textarea rows="5"></div>\n'+
    '<div class="info"><span class="name">问题选项</span><textarea rows="5" class="content repairment">'+dataLoad(order.repairment)+'</textarea rows="5"></div>';
...
function getEditOrderFinishedFormBodyHTML(order) {
    ...
    var orderFinishedFormBodyHTML = '<div class="info"><span class="name">报修人</span><input type="text" class="content user" value="'+dataLoad(order_user)+'" disabled></div>\n' +
        '<div class="info"><span class="name">地点</span><input type="text" class="content location" value="'+dataLoad(order.location)+'" disabled></div>\n'+
        '<div class="info"><span class="name">预约时间</span><input type="text" class="content beginTime" value="'+dateLoad(dataLoad(order.beginTime))+'" disabled></div>\n'+
        '<div class="info"><span class="name">开始时间</span><input type="text" class="content handleTime" value="'+dateLoad(dataLoad(order.handleTime))+'" disabled></div>\n'+
        '<div class="info"><span class="name">结束时间</span><input type="text" class="content endTime" value="'+dateLoad(dataLoad(order.endTime))+'" disabled></div>\n'+
...
function getAddUserFormBodyHTML() {
    var userFormBodyHTML =  '<div class="info"><span class="name">工号</span><input type="text" class="content id"></div>\n' +
        '<div class="info"><span class="name">姓名</span><input type="text" class="content name"></div>\n'+
        '<div class="info"><span class="name">联系方式</span><input type="text" class="content phone"></div>\n';
    return userFormBodyHTML;
}
//运维数据面板
function getAddOperatorFormBodyHTML() {
    var operatorFormBodyHTML =  '<div class="info"><span class="name">工号</span><input type="text" class="content id"></div>\n' +
        '<div class="info"><span class="name">姓名</span><input type="text" class="content name"></div>\n'+
        '<div class="info"><span class="name">联系方式</span><input type="text" class="content phone"></div>\n';
    return operatorFormBodyHTML;
}
...
function getAddOrderFormBodyHTML() {
    var orderFormBodyHTML = '<div class="info"><span class="name">报修人（工号）</span><input type="text" class="content user"></div>\n' +
        '<div class="info"><span class="name">地点</span><input type="text" class="content location"></div>\n'+
        '<div class="info"><span class="name">预约时间</span><input type="datetime-local" class="content beginTime"></div>\n'+
        '<div class="info"><span class="name">用户备注</span><textarea rows="5" class="content userDescription"></textarea rows="5"></div>\n'+
        '<div class="info"><span class="name">备注</span><textarea rows="5" class="content description"></textarea rows="5"></div>\n'+
        '<div class="info"><span class="name">问题选项</span><textarea rows="5" class="content repairment"></textarea rows="5"></div>';
    return orderFormBodyHTML;
}
//格式化列名
...
function addOrder() {
    ...
    var userDescription = $(".form .body .userDescription").text();
    var description = $(".form .body .description").text();
    var repairemnt = $(".form .body .repairment").text();
